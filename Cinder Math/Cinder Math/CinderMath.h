...
namespace Cinder
{
	namespace Math
	{
		...
		struct Vector3
		{
			...
			Vector3(Vector2<T> &vec2 = Vector2<T>(T(0), T(0)), T z = T(0));

			Vector3(T x = T(0), Vector2<T> &vec2 = Vector2<T>(T(0), T(0)));

			Vector3(Vector2<T> &vec2 = Vector2<T>(T(0), T(0)));
		...
		struct Vector4
		{
			...
			Vector4(Vector3<T> &vec3 = Vector3<T>(T(0), T(0), T(0)), T w = T(0));

			Vector4(T x = T(0), Vector3<T> &vec3 = Vector3<T>(T(0), T(0), T(0)));

			Vector4(Vector3<T> &vec3 = Vector3<T>(T(0), T(0), T(0)));

			Vector4(Vector2<T> &vec2 = Vector2<T>(T(0), T(0)));

			Vector4(Vector2<T> &vec2_1 = Vector2<T>(T(0), T(0)), Vector2<T> &vec2_2 = Vector2<T>(T(0), T(0)));

			Vector4(Vector2<T> &vec2 = Vector2<T>(T(0), T(0)), T z = T(0), T w = T(0));

			Vector4(T x = T(0), T y = T(0), Vector2<T> &vec2 = Vector2<T>(T(0), T(0)));
		...
		namespace Vec4
		{
			...
			template<typename T>
			void operator+=(Vector4<T> &v4Left, Vector4<T> &v4Right);
			template<typename T>
			void operator+=(Vector4<T> &v4Left, T &right);
